...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
			...
			<div class="container">
			  <a href="register.html"><img style="width:400px;" src="{{asset('bootshop/themes/images/carousel/2.png')}}" alt="special offers"/></a>
			...
			@php
				$featureds = \App\Model\Produk::get();
			@endphp

			@foreach($featureds as $lt)
				
				<div class="item">
				<div class="container">
				<a href="register.html"><img style="width:90%; height:400px" src="{{asset($lt->photo) }}" alt="special offers"/></a>
					<div class="carousel-caption">
						<h4>{{ $lt->nama}}</h4>
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
					</div>
...
<script src="{{asset('bootshop/themes/switch/theamswitcher.js')}}" type="text/javascript" charset="utf-8">
