...
<div class="span9">
	...
	<div class="row">	  
            ...
            <a href="{{ asset($dt->photo)}}" title="{{$dt->nama}}">
				<img src="{{ asset($dt->photo)}}" style="width:100%" alt="{{$dt->nama}}"/>
            </a>
			...
			<div class="span6">
				<h3>{{ $dt->nama}}  </h3>
				<small>-{{ $dt->kategoris->nama}}</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>Rp. {{number_format($dt->harga)}}</span></label>
					<div class="controls">
