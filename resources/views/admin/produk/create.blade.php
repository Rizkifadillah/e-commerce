...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <form role="form" method="post" action="{{ url('produk/add')}}" enctype="multipart/form-data">
                @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" value="{{ rand() }}" name="kode" id="" placeholder="Kode">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control"  name="berat" id="" placeholder="Harga">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control"  name="minimal_stock" id="" placeholder="Minimal Stock">
                </div>
